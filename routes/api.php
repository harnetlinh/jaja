...
Route::namespace('Api')->group(function() {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        Route::apiResource('department', 'DepartmentController')->middleware('permission:' . Acl::PERMISSION_PERMISSION_MANAGE);
        // Custom routes
        // Route::get('department', 'DepartmentController@index')->middleware('permission:' . Acl::PERMISSION_PERMISSION_MANAGE);
